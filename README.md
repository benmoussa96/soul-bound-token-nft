...
> :grey_exclamation: :grey_exclamation: **This type of token is called a Soul Bound Token because once the token has been claimed by the student, it can't be transfered to anyone else.**
